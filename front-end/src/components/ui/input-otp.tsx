...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        'relative flex h-12 w-10 items-center justify-center rounded-xl border border-border/80 bg-white text-base font-semibold shadow-xs transition-all outline-none',
